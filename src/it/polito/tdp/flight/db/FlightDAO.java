...
public class FlightDAO {
	...
	public List<Airline> listAllAirlines() {
		...
		String sql = "SELECT * FROM airline,route WHERE airline.Airline_ID = route.Airline_ID group by airline.Airline_ID" ; //solo le compagnie disponibili (con almeno una tratta attiva)
	...
	public List<Route> listAllRoutesForAirline(Airline airline) {
